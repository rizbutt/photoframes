...
import frameImage from "../../../../public/assets/images/electronics/pro/1.jpg"
import user from "../../../../public/assets/images/logos/1.png";

const Add_frame = ({ afterPaste, onBlur, onChange }) => {
	const usert  = localStorage.getItem("tokrn");
	console.log(usert);
